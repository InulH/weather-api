    ...
    background.weather.map(bg => {
        setTimeout(() => {
            if (bg.main == 'Clouds') {
                ...
                document.body.style.background = ' #7cc7d9'
            }
            else if (bg.main == 'Rain') {
                console.log(bg.main == 'Rain');
                document.body.style.background = '#C4D3DF';
            }
            else if (bg.main == 'Mist') {
                console.log(bg.main == 'Mist');
                document.body.style.background = '#84b9e4';
            }
            else if (bg.main == 'Haze') {
                console.log(bg.main == 'Haze');
                document.body.style.background = '#7D7098'
            }
            else if (bg.main == 'Fog') {
                console.log(bg.main == 'Fog');
                document.body.style.background = '#abaeb0'
            }
            else if (bg.main == 'Sand') {
                console.log(bg.main == 'Sand');
                document.body.style.background = '#C2B280';
            }
